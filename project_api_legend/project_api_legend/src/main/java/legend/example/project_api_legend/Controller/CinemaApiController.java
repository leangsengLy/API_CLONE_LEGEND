...
public class CinemaApiController {
    ...
    private LZCinemaRepository lzCinemaRepository;
     ...
     public ResponseEntity<?> Create(@RequestBody CinemaDataModel model) {
         try{
            if(model.getName().equals("") || model.getAddress()=="") return new ResponseEntity<>(LZGlobalHelper.Message.DataInvalid.setDetail("The field name  is required."),HttpStatus.BAD_REQUEST);
